...
function Icon({ name, size = 22, ...props }) {
  const paths = {
    ...
    chat: <><path d="M21 11.5a8.4 8.4 0 0 1-9 8.5 9.5 9.5 0 0 1-3.8-.9L3 21l1.8-5A8.7 8.7 0 1 1 21 11.5Z"/><path d="M8.5 8.2c.5 2.8 2.5 4.8 5.3 5.3"/></>,
  };
